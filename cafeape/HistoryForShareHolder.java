...
public class HistoryForShareHolder extends javax.swing.JFrame {

    public HistoryForShareHolder() {
        initComponents();
        showBills();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(HistoryForShareHolder.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
