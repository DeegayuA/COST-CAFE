...
public class BillMakerForCas extends javax.swing.JFrame {

    public BillMakerForCas() {
        initComponents();
        showProducts();
...
int Stock;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BillMakerForCas.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
